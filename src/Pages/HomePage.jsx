...
const HomePage = () => (
  <main>
    <a className={getClassName('pages__link')} href="/vim">
      <Section style={{ paddingBottom: '2.5rem' }} name="Switching to Vim">
    ...
    {/* <a className={getClassName('pages__link')} href="/engagement">
      <Section style={{ paddingBottom: '2.5rem' }} name="We just got engaged!">
        I finally got around to asking, and she said yes!
      </Section>
    </a> */}
    <a className={getClassName('pages__link')} href="/net-neutrality">
      <Section style={{ paddingBottom: '2.5rem' }} name="My Take on Net Neutrality">
